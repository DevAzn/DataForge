# DataForge skills (GitLab Duo)

Thin, request-scoped skills. **Pick one skill per task.** Do not invent extra work.

**Keep in sync** with project-root `skills/` (GitLab Agent Skills discovery path). Same `SKILL.md` bodies in both places.
...
- [`.gitlab/duo/chat-rules.md`](../chat-rules.md)

After editing any skill, update **both** trees, then start a **new Duo conversation**.
