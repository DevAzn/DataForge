...
**Agent operating system** for maximum **speed** and **production-quality** output.  
Power-user style: plan first, parallelize hard work, verify every ship, capture what worked as skills.

| Doc | Role |
|-----|------|
| **[AGENTS.md](./AGENTS.md)** (this file) | How agents build here |
| **[GROK_BUILD_SETUP.md](./GROK_BUILD_SETUP.md)** | Slash commands, loop, headless, first prompts |
| **[CONTEXT.md](./CONTEXT.md)** | Product intent, persistence, architecture |
...
- Export JSON / XML / CSV / YAML / TXT; archives; **multifile package variants**
...
| **pv-ui-workspace** | Shipped | Dynamic layout, nav density, brand, formats, workspaces |
...
| **pv-package**, **pv-generate-output**, **pv-delivery**, **pv-parity**, **pv-doc-sync** | Backlog | After real feature work |
